...
class TestLiveVodPlaylistLive:

    def test_live_vod_playlist_live(self):
        ...
        current_program_vod1 = utils.get_program_parameters(program_name="current")
        current_journey_vod1 = utils.get_journey_parameters(journey_datetime="current")
        ...
        previous_program_vod1 = utils.get_program_parameters(program_name="previous")
        current_program_playlist2 = utils.get_program_parameters(program_name="current")
        previous_journey_vod1 = utils.get_journey_parameters(journey_datetime="previous")
        ...
        assert previous_program_vod1 != {}
        assert previous_program_playlist2 != {}
        assert current_program_live3 != {}

        assert previous_program_vod1 == current_program_vod1
        assert previous_program_vod1 != current_program_playlist2
        assert previous_journey_vod1 == current_journey_vod1
        assert previous_journey_vod1 != current_journey_playlist2

        assert previous_program_vod1 != current_program_live3
        assert previous_program_playlist2 != current_program_live3
        assert previous_journey_vod1 != current_journey_live3
